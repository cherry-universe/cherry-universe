...
constexpr auto qt_meta_stringdata_CLASSMainWidgetENDCLASS = QtMocHelpers::stringData(
    ...
    "AUTHOR",
    "hgfugotry",
    "btnLocalHostName_clicked",
    "",
    "btnLocalIPAddress_clicked",
    "btnCheckIP_clicked",
    "hostText"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMainWidgetENDCLASS[] = {
 ...
 // slots: name, argc, parameters, tag, flags, initial metatype offsets
       3,    0,   34,    4, 0x08,    1 /* Private */,
       5,    0,   35,    4, 0x08,    2 /* Private */,
...
Q_CONSTINIT const QMetaObject MainWidget::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMainWidgetENDCLASS_t,
        ...
        // method 'btnLocalHostName_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'btnLocalIPAddress_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void MainWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->btnLocalHostName_clicked(); break;
        case 1: _t->btnLocalIPAddress_clicked(); break;
        case 2: _t->btnCheckIP_clicked((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
    }
}
